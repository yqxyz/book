                            ...
                            <div class="panel-body">
                                <fieldset class="form-horizontal">
                                    <form method="post" id="form1">
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">书籍分类:</label>
                                            <div class=" col-sm-10">
                                                <select class="chosen-select form-control" name="cid"
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">数量:</label>
                                            <div class="col-sm-10"><input type="text" value="1000" name="num" class="form-control"
                                                                          placeholder="..."></div>
                                        </div>

                                        <div class="form-group"><label class="col-sm-2 control-label">作者:</label>
                                            <div class="col-sm-10"><input type="text" name="auther" class="form-control"
                                                                          placeholder="..."></div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">描述:</label>
                                            <div class="col-sm-10"><input type="text" name="itemdesc"
