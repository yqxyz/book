        ...
        <div class="wrapper wrapper-content">
            <div class="container">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-2 pull-left" style="height: 100%;">
                            <ul class="list-group cat-list" style="background:#a3794e;min-height: 400px">

                            </ul>
                            <ul class="list-group hot-list" style="background:#a3794e;min-height: 400px">
                        ...
                        <div class="col-md-8" style="height: 400px">
                            <div class="carousel slide" id="carousel2">
                                <ol class="carousel-indicators">
                                    <c:forEach items="${bigImg}" var="big" varStatus="s">
                                        <c:if test="${s.count==1}">
                                            <li data-slide-to="0" data-target="#carousel2" class="active"></li>
                                        </c:if>
                                        <c:if test="${s.count!=1}">
                                            <li data-slide-to="${s.count}" data-target="#carousel2"></li>
                                        </c:if>
                                    </c:forEach>
                                </ol>
                                        ...
                                        <c:if test="${s.count==1}">
                                            <div class="item active">
                                                <img alt="image" class="img-responsive"
                                                     src="/img/item/${big.img}.jpg" style="width: 770px;height:350px">
                                                <div class="carousel-caption">
                                                    <a href="/item/${big.itemId}"><p>${big.name}</p></a>
                                                </div>
                                            </div>
                                        </c:if>
                                        <c:if test="${s.count!=1}">
                        ...
                        <div class="col-md-2 pull-left" style="height: 400px;">
                            <ul class="list-group recent-list" style="background:#a3794e;min-height: 400px">
    ...
    if (${items.size()!=0})
        $('#pagination-demo').twbsPagination({
            ...
            onPageClick: function (event, page) {
                var html = '';
                $.post('/index/item/ajax', {page: page}, function (data) {
                    for (i in data) {
